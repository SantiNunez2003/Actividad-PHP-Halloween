...
<body>
    <section id="admin" class="section">
        ...
        {
            $url = 'index.php?modulo=admin&accion=guardar_editar&id='.$_GET['id'];
            ...
            {
                $url = 'index.php?modulo=admin&accion=guardar_insertar';
            ...
            if(mysqli_num_rows($sql) != 0)
            {
                while($r = mysqli_fetch_array($sql))
                {
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="index.php?modulo=admin&accion=editar&id=<?php echo $r['id'];?>">Editar</a>
                            -
                            <a href="javascript:if(confirm('Desea eliminar el registro?')) window.location='index.php?modulo=admin&accion=guardar_eliminar&id=<?php echo $r['id'];?>'">Eliminar</a>
                        </td>
                    </tr>
                    <?php
                }
